package com.ingenium.double3rental.controllers;
...
public class HomepageController {
    ...
    public String homePage(HttpSession session, Model model) {
        ...
        ArrayList<RentalSession> rentalSessions = new ArrayList<>(user.getRentalSessions());
        model.addAttribute("sessions", rentalSessions);
